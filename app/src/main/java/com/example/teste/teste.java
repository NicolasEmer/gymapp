...
import com.example.teste.databinding.ActivityTesteBinding;
...
private ActivityTesteBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        setSupportActionBar(binding.appBarTeste.toolbar);
        binding.appBarTeste.fab.setOnClickListener(new View.OnClickListener() {
            @Override
